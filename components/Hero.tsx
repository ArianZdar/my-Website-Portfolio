    ...
    <div className='pb-20 pt-36' >
        ...
        <div className=' flex justify-center relative my-20 z-10 flex-col items-center'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                <TextGenerateEffect className="text-center text-[40px] md:text-5xl lg:text-6xl" words="Engineering reliable software solutions that make a difference, one line at a time." />
                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                    Hi I&apos;m Arian, Software Engineering student based in Montreal Canada
                </p>
